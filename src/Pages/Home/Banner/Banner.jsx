  ...
  return (
    <div className="bg-red-100 w-full h-auto tablet:h-[450px] laptop:h-[520px] laptopl:h-[750px] flex items-end justify-center">
      <div className="tablet:flex tablet:flex-row flex flex-col w-full">
        ...
        >
          <div className="text-2xl font-medium leading-[30px] animate-fadeinright text-center font-poppins w-full tablet:text-start mt-6 tablet:mt-0">
            Smart Products
          </div>
        ...
        >
          <img
            src={pngegg}
            alt="perfumes"
            className="object-contain absolute tablet:bottom-28 l:bottom-8 max-h-[95%] w-full animate-fadeinup"
          />
        </div>
      </div>
    </div>
